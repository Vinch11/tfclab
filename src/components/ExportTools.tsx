...
import { computeDecisionTFCL, type RaceReadinessV2Result, type ComputeDecisionInput, RACE_READINESS_V2_DEFINITIONS, RACE_READINESS_V2_DISCLAIMER, POTENTIAL_LEVELS, DISPONIBILITE_DECISION_LEVELS, RACE_READINESS_V2_CATEGORIES } from "@/lib/v2/raceReadinessV2";
...
interface ExportPayload {
  ...
  // ✅ NEW: Race Readiness V2 décisionnel
  raceReadinessV2: RaceReadinessV2Result;
