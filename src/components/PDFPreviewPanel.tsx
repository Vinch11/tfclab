...
const SECTION_ICONS: Record<keyof ReportSections, React.ComponentType<{ className?: string }>> = {
  ...
  twoForCoaching: Shield,
  wahoo: Settings,
  planSuggestion: CheckSquare,
  templateRecommendation: FileText,
  zones: Activity,
  historique: Clock,
  tests: TestTube2,
...
const SECTION_CATEGORIES: Record<keyof ReportSections, { label: string; color: string }> = {
  ...
  raceReadinessRunning: { label: "Running", color: "bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-400" },
  ...
  methodology: { label: "Entraînement", color: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400" },
  twoForCoaching: { label: "Entraînement", color: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400" },
  wahoo: { label: "Entraînement", color: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400" },
  planSuggestion: { label: "Entraînement", color: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400" },
  templateRecommendation: { label: "Entraînement", color: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400" },
