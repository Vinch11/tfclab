...
const STRENGTH_PRO: LibraryWorkout[] = [
  ...
  },
  {
    ...
    necessite: "Avancé trail (base solide requise)",
  ...
  },
  {
    ...
    necessite: "Avancé (≥1 cycle plyo basique fait)",
    when: "Build & Peak",
    phase: ["build", "peak"],
  ...
  },
  {
    ...
    necessite: "Recommandé route/CAP",
    when: "Base & début Build",
    phase: ["base", "build"],
  ...
  },
  {
    ...
    necessite: "Recommandé (trail prioritaire)",
    when: "Toute l'année",
    phase: ["base", "build", "peak", "taper"],
  ...
  },
  {
    ...
    necessite: "Critique (forte évidence préventive)",
  ...
  },
  {
    ...
    necessite: "Recommandé (bike/swim/tri)",
    when: "Toute l'année",
    phase: ["base", "build", "peak", "taper"],
    avoid: "—",
    durationMin: [20, 30],
