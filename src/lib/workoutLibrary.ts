...
export const WorkoutLibrary: LibraryWorkout[] = [
  ...
  // B – TRAIL INTENSITÉ
  {
    ...
    phase: ["base", "build"],
    avoid: "Achilles/mollet fragile_V16",
    durationMin: [45, 70],
    metricKey: "cardiaque",
    sportKey: "tout sport",
    structure: [
...
const SWIM_A_PRO: LibraryWorkout[] = [
  {
    ...
    when: "Toute l'année",
    phase: ["base", "build"],
    avoid: "Épaules douloureuses_V122",
    durationMin: [45, 70],
    metricKey: "allure",
    sportKey: "natation",
...
const SWIM_B_PRO: LibraryWorkout[] = [
  {
    ...
    when: "Build/Peak",
    phase: ["build", "peak"],
    avoid: "Épaules douloureuses_V123",
    durationMin: [50, 75],
    metricKey: "allure",
    sportKey: "natation",
  ...
  },
  {
    ...
    when: "Build/Peak",
    phase: ["build", "peak"],
    avoid: "Épaules douloureuses_V124",
    durationMin: [55, 80],
    metricKey: "allure",
    sportKey: "natation",
