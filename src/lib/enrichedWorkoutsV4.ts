...
const BRICK_C: LibraryWorkout[] = [
  ...
  },
  {
    ...
    structure: [
      ...
      { part: "Main", text: "Vélo: 3×(5min @95rpm Z3 + 5min @75rpm Z3). Transition immédiate. Course: 15min progression cadence 170→180spm, allure semi. Focus sensation jambes lourdes", zones: ["Z3", "Z4"] },
