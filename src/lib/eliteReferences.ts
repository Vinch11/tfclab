...
const ELITE_REFS: EliteReference[] = [
  ...
  // COMPETITOR
  { objective: "IM", ambition: "COMPETITOR", label: "Ironman Compétiteur", weeklyHours: [14, 20], weeklyKmRun: [35, 55], sessionsPerWeek: [8, 12], doublesPerWeek: [4, 7], keySessions: [2, 3], progressionPct: [5, 7], loadPattern: "3:1", swimPct: [15, 20], bikePct: [45, 55], runPct: [25, 30], longRunMax: "4-5h vélo" },
  ...
  // AGE_GROUP
  { objective: "IM", ambition: "AGE_GROUP", label: "Ironman Age Group", weeklyHours: [10, 15], weeklyKmRun: [25, 40], sessionsPerWeek: [6, 9], doublesPerWeek: [1, 3], keySessions: [2, 2], progressionPct: [3, 5], loadPattern: "3:1", swimPct: [15, 20], bikePct: [45, 55], runPct: [25, 35], longRunMax: "3.5-4h vélo" },
