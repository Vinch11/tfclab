...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  {
    id: "race-readiness",
    term: "Potentiel Physiologique",
    shortDefinition: "Score d'adéquation de ton profil pour ton objectif",
    fullDefinition: "Le Potentiel Physiologique évalue si ton profil métabolique actuel (VLamax, TTE, FTP/kg) est adapté aux exigences de ta course cible. Un score élevé signifie que tu es bien préparé ; un score bas indique des axes d'amélioration.",
    example: "Potentiel Physiologique 85% pour un Ironman = profil bien adapté à l'épreuve",
