...
export const PROGRAM_TEMPLATES: ProgramTemplate[] = [
  {
    ...
    target: "IM",
    source: "docx",
    docxPath: "/templates/TEMPLATE_IM_KONA.docx",
    weeks: [],
    multiSections: false,
  },
  {
    ...
    target: "703",
    source: "docx",
    docxPath: "/templates/TEMPLATE_IM_703.docx",
    weeks: [],
    multiSections: false,
  },
  {
    ...
    target: "Marathon",
    source: "docx",
    docxPath: "/templates/TEMPLATE_MARATHON.docx",
    weeks: [],
    multiSections: false,
  },
  {
    ...
    target: "Semi",
    source: "docx",
    docxPath: "/templates/TEMPLATE_SEMI.docx",
    weeks: [],
    multiSections: false,
  },
];
