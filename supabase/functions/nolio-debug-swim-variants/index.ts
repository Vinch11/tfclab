  ...
  try {
    ...
    if ((body as { cleanup?: boolean }).cleanup) {
      const ids = [
        ...
        338386478010, 338386478011, 338386478012, 338386478013,
        338386478014, 338386478015, 338386478016, 338386478017,
        338386478018, 338386478019, 3383864780110, 3383864780111,
      ];
